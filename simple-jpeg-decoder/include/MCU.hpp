...
namespace kpeg
{
    ...
    typedef std::vector<std::array<std::array<int, 8>, 8>> CompMatrices;
    ...
    class MCU
    {
        ...
        public:
            ...
            MCU(const std::vector<std::vector<int>>& compRLE,
            ...
            /// @param compRLE the run-length encoding for the MCU
            /// @param QTables the quantization tables to be used for encoding the MCU
            void constructMCU(const std::vector<std::vector<int>>& compRLE,
                              const std::vector<std::vector<UInt16>>& QTables);
            ...
            std::vector<std::array<int, 64>> zigzagify();

    ...
    class Decoder
    {
        public:
            ...
            enum ResultCode
            {
                SUCCESS,
                TERMINATE,
                ERRORR, // ERROR is defined in winsock lib
                DECODE_INCOMPLETE,
                DECODE_DONE
            };
        ...
        public:
            ...
            std::vector<std::array<int, 64>> get_raw_zigzags();

            void decode_only_header();

            void start_from(int bytes);
        private:
        ...
        public:
            ...
            // should be istream, but I am lazy
            ...
            int start = 0;
            std::pair<uint8_t, uint8_t> subsampling = {1, 1};
            uint8_t mcu_comp_cnt = 3;
